...
const EditAnnouncementModal = ({ open }: IProps) => {
          ...
          <Main>
            ...
            <Content>
              ...
              <div className="input-group">
                <Button
                  background={
                    publicated === 1 ? "var(--brand-1)" : "transparent"
                  }
                  border={
                    publicated === 1
                      ? "1.5px solid var(--brand-1)"
                  ...
                  color={publicated === 1 ? "var(--grey-10)" : "var(--grey-0)"}
                  description="Sim"
                  border_radius={4}
                  padding="12px 28px"
                  font_size={16}
                ...
                <Button
                  background={
                    publicated === 0 ? "var(--brand-1)" : "transparent"
                  }
                  border={
                    publicated === 0
                      ? "1.5px solid var(--brand-1)"
                  ...
                  color={publicated === 1 ? "var(--grey-0)" : "var(--grey-10)"}
                  description="Não"
                  border_radius={4}
                  padding="12px 28px"
                  font_size={16}
